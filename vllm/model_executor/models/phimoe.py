...
class PhiMoEForCausalLM(nn.Module, SupportsLoRA, SupportsPP, MixtureOfExperts):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        # Set MoE hyperparameters required by MixtureOfExperts protocol so that
        # EPLB (Expert Parallelism Load Balancing) can introspect this model.
        self.expert_weights = []
        ...
        if example_moe is None:
            raise RuntimeError("No PhiMoE layer found in model.layers.")
